...
ArrayCount = 0
Loop, Read, %A_ScriptDir%\proprio.txt
{
...
ArrayCount = 0
Loop, Read, %A_ScriptDir%\familia.txt   
{
    ArrayCount += 1  ; Keep track of how many items are in the array.
...
ArrayCount = 0
Loop, Read, %A_ScriptDir%\emails.txt   
{
    ArrayCount += 1  ; Keep track of how many items are in the array.
...
ArrayCount = 0
Loop, Read, %A_ScriptDir%\separador.txt   
{
    ArrayCount += 1  ; Keep track of how many items are in the array.
	...
	else
	{
		...
		Sleep 1000
		ImageSearch, botaox, botaoy, 0, 0, A_ScreenWidth, A_ScreenHeight, votar.bmp
		...
		ImageSearch, botaox, botaoy, 0, 0, A_ScreenWidth, A_ScreenHeight, field.bmp
